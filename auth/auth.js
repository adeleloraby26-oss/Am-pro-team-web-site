...
window.signup = async function() {
  var btn = document.querySelector("#signupBox button");
  ...
  try {
    ...
    if (!r1.data.user) {
      show("Please check your email to confirm your account!", "success");
      return;
    }
...
window.login = async function() {
  var btn = document.querySelector("#loginBox button");
  if (btn.disabled) return;
